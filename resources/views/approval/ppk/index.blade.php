        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">Review dan setujui anggaran kegiatan bimbingan teknis</p>
                </div>
            </div>
                    ...
                    <form method="GET" action="{{ route('approval.ppk.index') }}" class="flex flex-col sm:flex-row gap-4">
                        ...
                        <div class="flex gap-2">
                            ...
                            @if (request('search') || request('status'))
                                <a href="{{ route('approval.ppk.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 border border-transparent rounded-lg font-semibold text-sm text-gray-700 hover:bg-gray-300 transition">
                                    Reset
                                </a>
                            @endif
                        </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($pengajuans as $pengajuan)
                                <tr class="hover:bg-gray-50 {{ $pengajuan->status_pengajuan === 'disetujui_kepala' ? 'bg-blue-50' : '' }}">
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('approval.ppk.show', $pengajuan) }}" class="inline-flex items-center px-3 py-1.5 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition text-sm">
