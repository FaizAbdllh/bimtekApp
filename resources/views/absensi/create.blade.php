        ...
        <div>
            <nav class="flex mb-2" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 text-sm text-gray-500">
                    ...
                    <li><span class="mx-1">/</span></li>
                    <li class="text-gray-900 font-medium">Buat Sesi</li>
                </ol>
            </nav>
    ...
    <div class="py-6">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                <form action="{{ route('bimtek.absensi.store', $bimtek) }}" method="POST">
                    @csrf
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            @enderror
                            <p class="mt-1 text-sm text-gray-500">Nama yang mendeskripsikan sesi absensi ini.</p>
                        </div>
                                ...
                                <label class="relative flex cursor-pointer rounded-lg border bg-white p-4 shadow-sm focus:outline-none @error('status') border-red-500 @enderror">
                                    ...
                                    <span class="flex flex-1">
                                        <span class="flex flex-col">
                                            ...
                                            <span class="mt-1 flex items-center text-sm text-gray-500">Peserta dapat langsung melakukan absensi</span>
                                        </span>
                                    </span>
                                ...
                                <label class="relative flex cursor-pointer rounded-lg border bg-white p-4 shadow-sm focus:outline-none @error('status') border-red-500 @enderror">
                                    ...
                                    <span class="flex flex-1">
                                        <span class="flex flex-col">
                                            ...
                                            <span class="mt-1 flex items-center text-sm text-gray-500">Buat sesi dulu, buka nanti</span>
                                        </span>
                                    </span>
                                    <svg class="h-5 w-5 text-primary-600 hidden" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                    ...
                    <div class="px-6 py-4 bg-gray-50 border-t border-gray-100 flex items-center justify-end gap-3 rounded-b-xl">
                        <a href="{{ route('bimtek.absensi.index', $bimtek) }}" class="px-4 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition">
                            Batal
                        </a>
