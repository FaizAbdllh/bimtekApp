                ...
                @foreach($bimtekAktif as $bimtek)
                    <div class="border rounded-lg p-4 hover:shadow-md transition-shadow">
                        <div class="flex justify-between items-start mb-2">
                            <h4 class="font-medium text-gray-900">{{ $bimtek->judul_final }}</h4>
                            <span class="px-2 py-1 text-xs font-semibold rounded-full 
                                @if($bimtek->status_pelaksanaan == 'berlangsung') bg-green-100 text-green-800
                                @else bg-blue-100 text-blue-800 @endif">
                                {{ ucfirst(str_replace('_', ' ', $bimtek->status_pelaksanaan)) }}
                            </span>
                        </div>
                        <p class="text-sm text-gray-500 mb-2">
                            ...
                            {{ $bimtek->tanggal_mulai_aktual ? \Carbon\Carbon::parse($bimtek->tanggal_mulai_aktual)->format('d M Y') : '-' }} - {{ $bimtek->tanggal_selesai_aktual ? \Carbon\Carbon::parse($bimtek->tanggal_selesai_aktual)->format('d M Y') : '-' }}
                        </p>
                        ...
                        <a href="{{ route('bimtek.show', $bimtek) }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">Lihat Detail →</a>
                    </div>
                @endforeach
            </div>
        @else
            <div class="text-center py-8">
                ...
                <p class="text-sm text-gray-400">Hubungi panitia untuk mendaftar sebagai peserta.</p>
            </div>
        @endif
    </div>
</div>
    ...
    <div class="p-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <a href="#" class="flex flex-col items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                ...
                <span class="text-sm text-gray-700">Materi</span>
            </a>
            <a href="#" class="flex flex-col items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                <svg class="w-8 h-8 text-green-600 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path>
                </svg>
                <span class="text-sm text-gray-700">Tugas</span>
            </a>
            <a href="#" class="flex flex-col items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                <svg class="w-8 h-8 text-purple-600 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                </svg>
                <span class="text-sm text-gray-700">Absensi</span>
            </a>
            <a href="#" class="flex flex-col items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
