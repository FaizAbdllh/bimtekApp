                ...
                @foreach($bimtekAktif as $bimtek)
                    <div class="border rounded-lg p-4 hover:shadow-md transition-shadow">
                        <div class="flex justify-between items-start mb-2">
                            <h4 class="font-medium text-gray-900">{{ $bimtek->judul_final ?? $bimtek->judul_rencana }}</h4>
                            {{-- REFAKTORISASI: Mengubah status_pelaksanaan menjadi status terpadu baru --}}
                        ...
                        <p class="text-sm text-gray-500 mb-3">
                            ...
                            {{ $bimtek->lokasi_aktual ?? $bimtek->tempat_kegiatan_rencana ?? 'Lokasi belum ditentukan' }}
                        </p>
                        <a href="{{ route('bimtek.show', $bimtek->id) }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">Lihat Detail →</a>
                    </div>
                @endforeach
            </div>
        @else
            <div class="text-center py-8">
                ...
                <p class="text-sm text-gray-400">Hubungi panitia pokja untuk mendaftar sebagai peserta.</p>
            </div>
        @endif
    </div>
</div>
